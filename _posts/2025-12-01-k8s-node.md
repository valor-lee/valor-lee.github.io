---
title: '[k8s] 노드'
date: 2025-12-01 19:32:00 +09:00
...
2. Node 컴포넌트 (kubelet, kube-proxy, runtime)

3. Node 리소스 모델 (CPU/mem/ephemeral-storage/capacity/allocatable)

4. Pod 스케줄링과 Node

5. Pod 실행 라이프사이클과 Node의 역할

6. Node 네트워크 구조

7. Node 상태(Ready/NotReady)와 헬스 체크, Taint/Toleration

# 1. Node 객체(API 관점)

Node는 API Server에 등록되어 관리됨
